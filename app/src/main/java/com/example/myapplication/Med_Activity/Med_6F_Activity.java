...
public class Med_6F_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchButton.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                ...
                if(isChecked) {
                    Toast.makeText(Med_6F_Activity.this,"모든 대피로", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Med_6F_Activity.this,"경로 리셋", Toast.LENGTH_SHORT).show();
    ...
    public class FL6View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1040,400);
            path.lineTo(1040,510);
            path.lineTo(1350,510);
            path.lineTo(1350,620);
            path.lineTo(1450,620);
    ...
    public class FL7View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1240,400);
            path.lineTo(1240,510);
            path.lineTo(1350,510);
            path.lineTo(1350,620);
            path.lineTo(1450,620);
    ...
    public class FL8View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1440,400);
            path.lineTo(1440,510);
            path.lineTo(1350,510);
            path.lineTo(1350,620);
            path.lineTo(1450,620);
    ...
    public class FL9View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1680,400);
            path.lineTo(1680,510);
            path.lineTo(1350,510);
            path.lineTo(1350,620);
            path.lineTo(1450,620);
    ...
    public class FL11View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1770,680);
            path.lineTo(1770,510);
            path.lineTo(1350,510);
            path.lineTo(1350,620);
            path.lineTo(1450,620);
    ...
    private void moving_603() {
        final Button button = (Button) findViewById(R.id.med_603);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX",  370, 370, 580, 580);
    ...
    private void moving_608() {
        final Button button = (Button) findViewById(R.id.med_608);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1390, 1390, 1300, 1300, 1400);
                animation1.setDuration(1900);
                animation1.start();
    ...
    private void moving_609() {
        final Button button = (Button) findViewById(R.id.med_609);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1630, 1630, 1300, 1300, 1400);
    ...
    private void moving_610() {
        final Button button = (Button) findViewById(R.id.med_610);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1830, 1830, 1300, 1300, 1400);
                animation1.setDuration(1500);
                animation1.start();
    ...
    private void moving_611() {
        final Button button = (Button) findViewById(R.id.med_611);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1720, 1720, 1300, 1300, 1400);
                animation1.setDuration(1900);
                animation1.start();
    ...
    private void moving_612() {
        final Button button = (Button) findViewById(R.id.med_612);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX", 1080, 1080, 1300, 1300, 1400);
