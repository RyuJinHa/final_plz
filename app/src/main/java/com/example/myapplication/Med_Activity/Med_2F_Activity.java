...
public class Med_2F_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchButton.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                ...
                if(isChecked) {
                    Toast.makeText(Med_2F_Activity.this,"모든 대피로", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Med_2F_Activity.this,"경로 리셋", Toast.LENGTH_SHORT).show();
    ...
    public class FL5View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            MyPaint.setColor(Color.parseColor("#FF9090"));
            Path path = new Path();
            path.moveTo(1330,400);
            path.lineTo(1330,600);
            path.lineTo(1420,600);
    ...
    public class FL6View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1500,400);
            path.lineTo(1500,500);
            path.lineTo(1350,500);
    ...
    public class FL7View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1710,400);
            path.lineTo(1710,500);
            path.lineTo(1350,500);
            path.lineTo(1350,600);
            path.lineTo(1420,600);
    ...
    public class FL9View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1840,680);
            path.lineTo(1840,500);
            path.lineTo(1350,500);
            path.lineTo(1350,600);
            path.lineTo(1420,600);
            canvas.drawPath(path, MyPaint);
    ...
    public class FL10View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1650,680);
            path.lineTo(1650,500);
            path.lineTo(1350,500);
            path.lineTo(1350,600);
            path.lineTo(1420,600);
    ...
    public class finalView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(250,510);
            path.lineTo(1850,510);

            path.moveTo(630,510);
            path.lineTo(630,650);

            path.moveTo(1350,500);
            path.lineTo(1350,600);
            path.lineTo(1420,600);
    ...
    private void moving_204() {
        final Button b = (Button) findViewById(R.id.med_204);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX",  580, 580); //x 좌표
                animation1.setDuration(1600);
                animation1.start();
    ...
    private void moving_205() {
        final Button b = (Button) findViewById(R.id.med_205);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX",  1280, 1280, 1370); //x 좌표
                animation1.setDuration(1600);
                animation1.start();

                ObjectAnimator animation3 = ObjectAnimator.ofFloat(iv, "translationY",  350, 550, 550); //y 좌표
                animation3.setDuration(1600);
                animation3.start();
    ...
    private void moving_206() {
        final Button b = (Button) findViewById(R.id.med_206);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX",  1450, 1450, 1300, 1300, 1370); //x 좌표
                animation1.setDuration(1600);
                animation1.start();
    ...
    private void moving_207() {
        final Button b = (Button) findViewById(R.id.med_207);
        final ImageView iv = (ImageView) findViewById(R.id.imageView1);
        final FrameLayout fl1 = (FrameLayout)findViewById(R.id.fl1);
        final FrameLayout fl2 = (FrameLayout)findViewById(R.id.fl2);
        final FrameLayout fl3 = (FrameLayout)findViewById(R.id.fl3);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation1 = ObjectAnimator.ofFloat(iv, "translationX",  1660, 1660, 1300, 1300, 1370); //x 좌표
                animation1.setDuration(1600);
                animation1.start();
