...
public class Prime_1F_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchButton.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                ...
                if(isChecked) {
                    Toast.makeText(Prime_1F_Activity.this,"모든 대피로", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Prime_1F_Activity.this,"경로 리셋", Toast.LENGTH_SHORT).show();
    ...
    public class FL1View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            path.lineTo(1430,440);
            path.lineTo(1670,440);
    ...
    public class FL2View extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            Path path = new Path();
            path.moveTo(1250,540);
            path.lineTo(1430,540);
            path.lineTo(1430,440);
            path.lineTo(1670,440);
    ...
    public class finalView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            path.moveTo(1670,390);
            path.lineTo(1670,550);
    ...
    private void moving_101() {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation3 = ObjectAnimator.ofFloat(iv, "translationY", 490, 390, 390); //y 좌표
    ...
    private void moving_102() {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation3 = ObjectAnimator.ofFloat(iv, "translationY",  490, 490, 390, 390); //y 좌표
    ...
    private void moving_104() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation3 = ObjectAnimator.ofFloat(iv, "translationY",  620, 490, 490, 390, 390);
    ...
    private void moving_105() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animation3 = ObjectAnimator.ofFloat(iv, "translationY",  490, 490, 390, 390);
